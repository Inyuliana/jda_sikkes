...
<head>
    ...
    <title>Dashboard · SIKKes v1.0</title>
</head>
...
<body>
    ...
    <main class="container">
        <div class="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm">
            <img class="me-3" src="{{ asset('image/Dinkes.png') }}" alt="" width="50" height="50">
            <div class="lh-1">
                <h1 class="h6 mb-0 text-white lh-1">Sistem Informasi Kepegawaian Kesehatan Ciamis</h1>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <h6 class="border-bottom pb-2 mb-0">Daftar Pegawai Yang Anak Naik Jabatan</h6>
            <div class="d-flex text-body-secondary pt-3">
                <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32"
                    xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32"
                    preserveAspectRatio="xMidYMid slice" focusable="false">
